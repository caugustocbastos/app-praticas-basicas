...
import 'editar_pratica_diaria_model.dart';
export 'editar_pratica_diaria_model.dart';

class EditarPraticaDiariaWidget extends StatefulWidget {
  const EditarPraticaDiariaWidget({
    super.key,
  ...
  @override
  State<EditarPraticaDiariaWidget> createState() =>
      _EditarPraticaDiariaWidgetState();
}

class _EditarPraticaDiariaWidgetState extends State<EditarPraticaDiariaWidget> {
  late EditarPraticaDiariaModel _model;
