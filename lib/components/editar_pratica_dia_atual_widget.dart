...
import 'editar_pratica_dia_atual_model.dart';
export 'editar_pratica_dia_atual_model.dart';

class EditarPraticaDiaAtualWidget extends StatefulWidget {
  const EditarPraticaDiaAtualWidget({
    super.key,
    required this.pessoaLogada,
    required this.rowDiario,
  });

  final PessoaRow? pessoaLogada;
  final DiarioRow? rowDiario;

  @override
  State<EditarPraticaDiaAtualWidget> createState() =>
      _EditarPraticaDiaAtualWidgetState();
}

class _EditarPraticaDiaAtualWidgetState
    extends State<EditarPraticaDiaAtualWidget> {
  late EditarPraticaDiaAtualModel _model;
    ...
    return Padding(
      ...
      child: FutureBuilder<List<DiarioRow>>(
        ...
        builder: (context, snapshot) {
          ...
          List<DiarioRow> containerDiarioRowList = snapshot.data!;

          // Return an empty Container when the item does not exist.
          if (snapshot.data!.isEmpty) {
            return Container();
          }
          final containerDiarioRow = containerDiarioRowList.isNotEmpty
              ? containerDiarioRowList.first
              : null;
                                          ...
                                          children: [
                                            ...
                                            TextFormField(
                                              controller: _model
                                                  ...
                                                  TextEditingController(
                                                text: containerDiarioRow?.oracao
                                                    ?.toString(),
                                              ),
                                              focusNode:
                                                  _model.txtOracaoFocusNode,
                                              onChanged: (_) =>
                                            ...
                                            TextFormField(
                                              controller: _model
                                                  ...
                                                  TextEditingController(
                                                text: containerDiarioRow?.johrei
                                                    ?.toString(),
                                              ),
                                              focusNode:
                                                  _model.txtJohreiFocusNode,
                                              onChanged: (_) =>
                                                  EasyDebounce.debounce(
                                            ...
                                            TextFormField(
                                              controller: _model
                                                  ...
                                                  TextEditingController(
                                                text: containerDiarioRow
                                                    ?.ensinamento
                                                    ?.toString(),
                                              ),
                                              focusNode: _model
                                                  .txtEnsinamentoFocusNode,
                                              onChanged: (_) =>
                                                  EasyDebounce.debounce(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.erro = await actions.verificaErro(
                            () async {
                              await DiarioTable().update(
                                data: {
                                  'johrei': double.tryParse(
                                      _model.txtJohreiTextController.text),
                                  'ensinamento': double.tryParse(
                                      _model.txtEnsinamentoTextController.text),
                                  'donativo': _model.valorMoeda,
                                  'dedicacao': double.tryParse(
                                      _model.txtDedicacaoTextController.text),
                                  'encaminhamento': double.tryParse(_model
                                      .txtEncaminhamentoTextController.text),
                                  'relato': _model.txtRelatoTextController.text,
                                  'oracao': double.tryParse(
                                      _model.txtOracaoTextController.text),
                                },
