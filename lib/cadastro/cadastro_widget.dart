                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 24.0),
                                    child: Text(
                                      'Participe da Construção do Paraíso Terrestre',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.nomeCadastroTextController,
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 16.0),
                                    child: FutureBuilder<List<IgrejaRow>>(
                                      future: IgrejaTable().queryRows(
                                        queryFn: (q) =>
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<IgrejaRow>
                                            ddIgrejaCadastroIgrejaRowList =
                                            snapshot.data!;

                                        return FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .ddIgrejaCadastroValueController ??=
                                              FormFieldController<String>(
                                            _model.ddIgrejaCadastroValue ??= '',
                                          ),
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller: _model
                                              .ddUnidadeCadastroValueController ??=
                                          FormFieldController<String>(
                                        _model.ddUnidadeCadastroValue ??= '',
                                      ),
                                      options: List<String>.from(_model
                                          .listaUnidade
                                          .map((e) => e.id)
                                          .toList()),
                                      optionLabels: _model.listaUnidade
                                          .map((e) => e.nome)
                                          .withoutNulls
                                          .toList(),
                                      ...
                                      hintText: 'Sua Unidade',
                                      searchHintText: 'Nome da Unidade',
                                      icon: Icon(
                                        Icons.keyboard_arrow_down_rounded,
                                        color: FlutterFlowTheme.of(context)
                                            .secondaryText,
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.ddIgrejaCadastroValue ==
                                            null) {
                                          return;
                                        }
                                        if (_model.ddUnidadeCadastroValue ==
                                            null) {
                                          await showDialog(
                                            context: context,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: Image.asset(
                            'assets/images/mount-fuji-8010752_1920.jpg',
                          ).image,
                        ),
