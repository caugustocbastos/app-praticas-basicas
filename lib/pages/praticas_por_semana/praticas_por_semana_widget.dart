...
import 'praticas_por_semana_model.dart';
export 'praticas_por_semana_model.dart';

class PraticasPorSemanaWidget extends StatefulWidget {
  const PraticasPorSemanaWidget({
    super.key,
  ...
  @override
  State<PraticasPorSemanaWidget> createState() =>
      _PraticasPorSemanaWidgetState();
}

class _PraticasPorSemanaWidgetState extends State<PraticasPorSemanaWidget>
    with TickerProviderStateMixin {
  late PraticasPorSemanaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PraticasPorSemanaModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.dataTypeMaioresValores = [];
      safeSetState(() {});
      _model.resumoMelhorSemana = await ResumoMelhoresPraticasCall.call(
        idpessoa: widget!.paramPessoaLogado?.id,
        ano: functions.anoNumero(getCurrentTimestamp),
        agrupamento: 'semana',
      );

      if ((_model.resumoMelhorSemana?.succeeded ?? true)) {
        _model.dataTypeMaioresValores =
            ((_model.resumoMelhorSemana?.jsonBody ?? '')
                    .toList()
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<DiarioResumoSemanalRow>>(
      future: DiarioResumoSemanalTable().queryRows(
        queryFn: (q) => q
            .eq(
              'idPessoa',
      ...
      builder: (context, snapshot) {
        ...
        List<DiarioResumoSemanalRow>
            praticasPorSemanaDiarioResumoSemanalRowList = snapshot.data!;
              ...
              title: Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'visualize seu desempenho por semana',
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Builder(
                        builder: (context) {
                          final listaPraticas =
                              praticasPorSemanaDiarioResumoSemanalRowList
                                  .toList();
                          ...
                          return FlutterFlowDataTable<DiarioResumoSemanalRow>(
                              ...
                              cells: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        listaPraticasItem.periodoSemana,
                                        '0',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
