...
import 'praticas_por_mes_model.dart';
export 'praticas_por_mes_model.dart';

class PraticasPorMesWidget extends StatefulWidget {
  const PraticasPorMesWidget({
    super.key,
  ...
  @override
  State<PraticasPorMesWidget> createState() => _PraticasPorMesWidgetState();
}

class _PraticasPorMesWidgetState extends State<PraticasPorMesWidget>
    with TickerProviderStateMixin {
  late PraticasPorMesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PraticasPorMesModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.dataTypeMaioresValores = [];
      safeSetState(() {});
      _model.resumoMelhorMes = await ResumoMelhoresPraticasCall.call(
        idpessoa: widget!.paramPessoaLogado?.id,
        ano: functions.anoNumero(getCurrentTimestamp),
        agrupamento: 'mes',
      );

      if ((_model.resumoMelhorMes?.succeeded ?? true)) {
        _model.dataTypeMaioresValores =
            ((_model.resumoMelhorMes?.jsonBody ?? '')
                    .toList()
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<DiarioResumoMesRow>>(
      future: DiarioResumoMesTable().queryRows(
        queryFn: (q) => q
            .eq(
              'idPessoa',
      ...
      builder: (context, snapshot) {
        ...
        List<DiarioResumoMesRow> praticasPorMesDiarioResumoMesRowList =
            snapshot.data!;
              ...
              title: Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'visualize seu desempenho por mês',
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Builder(
                        builder: (context) {
                          final listaPraticas =
                              praticasPorMesDiarioResumoMesRowList.toList();
                          ...
                          return FlutterFlowDataTable<DiarioResumoMesRow>(
