...
import 'praticas_por_mes_widget.dart' show PraticasPorMesWidget;
...
class PraticasPorMesModel extends FlutterFlowModel<PraticasPorMesWidget> {
  ...
  // Stores action output result for [Backend Call - API (resumoMelhoresPraticas)] action in PraticasPorMes widget.
  ApiCallResponse? resumoMelhorMes;
  // State field(s) for PaginatedDataTable widget.
  final paginatedDataTableController =
      FlutterFlowDataTableController<DiarioResumoMesRow>();
